...
public final class EasyTotalizer extends Contract {
    ...
    public static RemoteCall<EasyTotalizer> deploy(Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit, String _title, String _desc, BigInteger _minBet, BigInteger _percent, String _organizer, List<byte[]> _variants) {
    ...
    public static RemoteCall<EasyTotalizer> deploy(Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit, String _title, String _desc, BigInteger _minBet, BigInteger _percent, String _organizer, List<byte[]> _variants) {
        String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.<Type>asList(new org.web3j.abi.datatypes.Utf8String(_title), 
                new org.web3j.abi.datatypes.Utf8String(_desc), 
                new org.web3j.abi.datatypes.generated.Uint256(_minBet), 
                new org.web3j.abi.datatypes.generated.Uint8(_percent), 
